...
impl ChatTree {
    ...
    pub fn select_child_with_path(&mut self, path: &Vec<usize>, child_index: usize) -> Result<(), String> {
    ...
    pub fn select_child_from_index(&mut self, index : usize, child_index: usize) -> Result<(), String> {
